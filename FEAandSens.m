function [frequencies, dfreqfx_full] = FEAandSens(x,Lx,Ly,startingV,itr)
    ...
    for mode = 1:num_eigenvalues
        ...
        dfreqfx1 = dfreqfx1 / max(abs(dfreqfx1));
        dfreqfx2 = flipud(reshape(dfreqfx1, [nely, nelx]));
